...
export function CreateDebtModal({
  ...
  async function handleSubmit() {
    if (!form.title || !form.totalOwed) return
    setSaving(true)
    await createDebt({
      title: form.title,
    ...
    setSaving(false)
    setOpen(false)
    setForm({ title: '', totalOwed: '', assignedTo: '', provisioningId: '', description: '' })
    router.refresh()
  }
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative bg-background rounded-xl shadow-2xl w-full max-w-md mx-4">
            <div className="flex items-center justify-between px-4 py-3 border-b">
              <h2 className="text-sm font-semibold">New debt record</h2>
              <button
            ...
            <div className="px-4 py-4 space-y-4">
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  placeholder="e.g. Outstanding balance - March"
                />
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <Textarea
                  ...
                  placeholder="Details about the debt..."
            ...
            <div className="px-4 py-3 border-t flex justify-end gap-2">
              ...
              <Button onClick={handleSubmit} disabled={saving || !form.title || !form.totalOwed}>
